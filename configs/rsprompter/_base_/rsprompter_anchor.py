work_dir = './work_dirs/rsprompter/rsprompter-anchor'
default_scope = 'mmdet'
...
model = dict(
    ...
    neck=dict(
        ...
        feature_aggregator=dict(
            ...
            hidden_channels=32,
            select_layers=range(1, 32+1, 2),# should be changed when using different pretrain model, base: range(1, 13, 2), large: range(1, 25, 2), huge: range(1, 33, 2)
        ),
