...
# DPT
# depth_root_train="/data2/yihan/MyDataset/UIIS/UDW/train_depth_heat/"
# depth_root_val="/data2/yihan/MyDataset/UIIS/UDW/val_depth_heat/"
# depth_root_test=depth_root_val

# DAv1
# depth_root_train="/data2/yihan/MyDataset/UIIS/UDW/train_Depth_heat_DAv1/"
# depth_root_val="/data2/yihan/MyDataset/UIIS/UDW/val_Depth_heat_DAv1/"
# depth_root_test=depth_root_val

# ZoeDepth
# depth_root_train="/data2/yihan/MyDataset/UIIS/UDW/train_Depth_heat_ZoeDepth/"
# depth_root_val="/data2/yihan/MyDataset/UIIS/UDW/val_Depth_heat_ZoeDepth/"
# depth_root_test=depth_root_val
...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         # depth_root="/data1/yihan/MyDataset/UIIS/UDW/train_depth_heat/",
         # depth_root="/data2/yihan/MyDataset/UIIS/UDW/train_depth_heat_DAV2/",
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         # depth_root="/data1/yihan/MyDataset/UIIS/UDW/val_depth_heat/",
         # depth_root="/data2/yihan/MyDataset/UIIS/UDW/val_depth_heat_DAV2/",
...
# data_root = "/data3/yihan/MyDataset/UIIS/UDW/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
data_root = "/data2/yihan/MyDataset/UIIS/UDW/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
...
custom_hooks.append(
    dict(
        type='EvalTestHook',
        test_dataloader_cfg=test_dataloader,
        test_evaluator_cfg=test_evaluator
    )
)
'''
