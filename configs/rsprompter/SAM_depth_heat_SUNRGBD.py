...
hf_sam_pretrain_name = "/data3/yihan/MyProject/RSPrompter-release/sam-vit-large"
...
hf_sam_pretrain_ckpt_path = "/data3/yihan/MyProject/RSPrompter-release/sam-vit-large/pytorch_model.bin"
...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/SUNRGBD_kv2/train_depth_heat/",
         depth_root="/data3/yihan/MyDataset/SUNRGBD_kv2/train_depth_heat/",
         # depth_root="/root/shared-nvme/MyDataset/SUNRGBD_kv2/train_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/SUNRGBD_kv2/val_depth_heat/",
         depth_root="/data3/yihan/MyDataset/SUNRGBD_kv2/val_depth_heat/",
         # depth_root="/root/shared-nvme/MyDataset/SUNRGBD_kv2/val_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
dataset_type = 'SUNRGBD_Ins_Dataset'



# data_root = "/data2/yihan/MyDataset/SUNRGBD_kv2/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
data_root = "/data3/yihan/MyDataset/SUNRGBD_kv2/"
# data_root = "/root/shared-nvme/MyDataset/SUNRGBD_kv2/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file="/data2/yihan/MyDataset/SUNRGBD_kv2/annotations/instances_train.json",
        ann_file="/data3/yihan/MyDataset/SUNRGBD_kv2/annotations/instances_train.json",
        # ann_file="/root/shared-nvme/MyDataset/SUNRGBD_kv2/annotations/instances_train.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # depth_root="/root/shared-nvme/MyDataset/SUNRGBD_kv2/val_depth_heat/",
        depth_suffix=depth_suffix,
        # ann_file="/data2/yihan/MyDataset/SUNRGBD_kv2/annotations/instances_val.json",
        ann_file="/data3/yihan/MyDataset/SUNRGBD_kv2/annotations/instances_val.json",
        # ann_file="/root/shared-nvme/MyDataset/SUNRGBD_kv2/annotations/instances_val.json",
        data_prefix=dict(img=''),
