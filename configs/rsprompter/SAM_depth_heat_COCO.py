...
# crop_size = (1024, 1024)
# crop_size = (256, 512)
# crop_size = (512, 1024) # Cityscapes
crop_size = (1024, 640) # COCO
# crop_size = (768, 1536)
# crop_size = (1280, 1280)
# crop_size = (1536, 1536)
# crop_size = (1792, 1792)
...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         depth_root="/data2/yihan/MyDataset/coco2017/train2017_DAv2_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    dict(type='RandomFlip', prob=0.5),
    ...
    dict(
        ...
        # keep_ratio=True
        type='RandomResize',
        # scale=(256, 256),   # 高度基准 256
        scale=(crop_size[0], crop_size[0]),   # 高度基准 512
        ratio_range=(0.5, 1.0),  # 把高度从 256~512 随机, w按比例取
        keep_ratio=True
    ),
    dict(
        type='RandomCrop',
...
val_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         depth_root="/data2/yihan/MyDataset/coco2017/val2017_DAv2_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
