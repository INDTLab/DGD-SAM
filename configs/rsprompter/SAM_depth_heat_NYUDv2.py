...
default_hooks = dict(
    ...
    # visualization=dict(type='DetVisualizationHook', draw=True, show=False, score_thr=0.3, interval=1),
)
# 添加自定义 Hook的配置
custom_hooks = [
...
# hf_sam_pretrain_name = "/data3/yihan/MyProject/RSPrompter-release/sam-vit-huge"
...
# hf_sam_pretrain_ckpt_path = "/data3/yihan/MyProject/RSPrompter-release/sam-vit-huge/pytorch_model.bin"
...
#          depth_root="/data2/yihan/MyDataset/NYUDv2/depth_heat/",
#          # depth_root="/data3/yihan/MyDataset/NYUDv2/depth_heat/",
#          # depth_root="/root/shared-nvme/MyDataset/NYUDv2/depth_heat/",
#          suffix=depth_suffix,
#          to_float32=True),
...
#         # scale=[(768, 576), (768, 512)],
#         # keep_ratio=True
#         type='RandomResize',
#         scale=crop_size,
#         ratio_range=(0.1, 2.0),
#         #ratio_range=(0.5, 2.0), # 改小缩放比例，保护 small 目标
#         resize_type='Resize',
#         keep_ratio=True
#     ),
...
data_root = "/data2/yihan/MyDataset/NYUDv2/" # 影响下面的data_prefix=dict(img='train'), 要求“data_root + data_prefix + 标注.json中的file_name” 必须能定位到一张图像
# data_root = "/data3/yihan/MyDataset/NYUDv2/"
# data_root = "/root/shared-nvme/MyDataset/NYUDv2/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/NYUDv2/annotations/instances_train.json",
        # ann_file="/data3/yihan/MyDataset/NYUDv2/annotations/instances_train.json",
        # ann_file="/root/shared-nvme/MyDataset/NYUDv2/annotations/instances_train.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # depth_root="/root/shared-nvme/MyDataset/NYUDv2/depth_heat/",
        depth_suffix=depth_suffix,
        ann_file="/data2/yihan/MyDataset/NYUDv2/annotations/instances_val.json",
        # ann_file="/data3/yihan/MyDataset/NYUDv2/annotations/instances_val.json",
        # ann_file="/root/shared-nvme/MyDataset/NYUDv2/annotations/instances_val.json",
        data_prefix=dict(img=""),
