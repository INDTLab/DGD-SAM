...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         depth_root="/data2/yihan/MyDataset/NWPU/imgs_depth_heat/",
         # depth_root="/data3/yihan/MyDataset/NWPU/imgs_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
# data_root = "/data1/yihan/MyDataset/UIIS/UDW/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
# data_root = "/data2/yihan/MyDataset/USIS10K/"
# data_root = "/root/shared-nvme/MyDataset/LIACi_dataset_pretty/"
data_root = "/data2/yihan/MyDataset/NWPU/"
# data_root = "/data3/yihan/MyDataset/NWPU/imgs/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/NWPU/annotations/NWPU_instances_train.json",
        # ann_file="/data3/yihan/MyDataset/NWPU/annotations/NWPU_instances_train.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/NWPU/annotations/NWPU_instances_val.json",
        # ann_file="/data3/yihan/MyDataset/NWPU/annotations/NWPU_instances_val.json",
        data_prefix=dict(img='imgs'),
...
# resume = True
# load_from = "/data2/yihan/MyProject/RSPrompter-release/work_dirs/NWPU_ori/epoch_138.pth"
resume = False
load_from = None
