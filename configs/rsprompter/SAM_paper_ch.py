...
# num_classes = 1 # USIS10K_foreground
num_classes = 1 # COME

# num_classes = 10 # UIIS10K
#num_classes = 158 # USIS16K
...
model = dict(
    ...
    neck=dict(
        ...
        feature_aggregator=dict(
            ...
            # type='PseudoFeatureAggregatorV2',
            # type='NULLPseudoFeatureAggregator',
            in_channels=256,
            hidden_channels=512,
            # hidden_channels=256,
...
# dataset_type = 'USIS10K_foreground_InsSegDataset'
dataset_type = 'COMEDataset'

# dataset_type = 'UIIS10KDataset'
# dataset_type = 'USIS16KDataset'
...
# data_root = "/data2/yihan/MyDataset/USIS16K/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file="/data2/yihan/MyDataset/USIS10K/foreground_annotations/foreground_train_annotations.json",
        # data_prefix=dict(img='train'),
        ...
        # USIS16K
        # ann_file="/data2/yihan/MyDataset/USIS16K/annotations/instances_train2017.json",
        # data_prefix=dict(img='train2025'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file="/data2/yihan/MyDataset/USIS10K/foreground_annotations/foreground_val_annotations.json",
        # data_prefix=dict(img='val'),
        ...
        # USIS16K
        # ann_file="/data2/yihan/MyDataset/USIS16K/annotations/instances_test2017.json",
        # data_prefix=dict(img='test2025'),
