...
# hf_sam_pretrain_name = "/data2/yihan/MyProject/RSPrompter-release/sam-vit-huge"
...
# hf_sam_pretrain_ckpt_path = "/data2/yihan/MyProject/RSPrompter-release/sam-vit-huge/pytorch_model.bin"
# hf_sam_pretrain_ckpt_path = "/root/shared-nvme/MyProject/RSPrompter-release/sam-vit-base/pytorch_model.bin"

# DPT
#depth_root_train="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/train_depth_heat_DPT/"
#depth_root_val="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/val_depth_heat_DPT/"
#depth_root_test="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/test_depth_heat_DPT/"

# ZoeDepth
# depth_root_train="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/train_depth_heat_ZoeDepth/"
# depth_root_val="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/val_depth_heat_ZoeDepth/"
# depth_root_test="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/test_depth_heat_ZoeDepth/"

# DAv1
depth_root_train="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/train_depth_heat_DAv1/"
depth_root_val="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/val_depth_heat_DAv1/"
depth_root_test="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/test_depth_heat_DAv1/"
...
test_pipeline = [
    ...
    # dict(type='DualPad', size=crop_size, pad_val=dict(img=(0, 0, 0), depth=(0, 0, 0), masks=0)),
    # If you don't have a gt annotation, delete the pipeline
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    dict(
        type='PackDetInputs',
...
''' 换数据集，修改这里 '''
dataset_type = 'MyCityscapesDataset'
data_root = "/data2/yihan/MyDataset/Cityscapes/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/Cityscapes/annotations/cityscapes_instances_train_flatten_Info&License.json",
        data_prefix=dict(img="leftImg8bit_re_order"), # 标注里的 file_name为val/xxxxxxxxxx.png，包含了train、val，因此data_prefix这里不用再加了
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        depth_root=depth_root_val,
        depth_suffix=depth_suffix,
        ann_file="/data2/yihan/MyDataset/Cityscapes/annotations/cityscapes_instances_val_flatten_Info&License.json",
        data_prefix=dict(img="leftImg8bit_re_order"),
        pipeline=val_pipeline,
    )
)

test_dataloader = val_dataloader # 不往官网提交就用这个
# test_dataloader = dict( # 往官网提交就用这个
#     batch_size=batch_size_per_gpu,
#     num_workers=num_workers,
#     persistent_workers=persistent_workers,
#     # num_workers=0, # 2025-02-24为了调试，设为 0
...
#         # type=dataset_type,
#         # data_root=data_root,
#         # depth_root="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/test_depth_heat/",
#         # depth_suffix=depth_suffix,
#         # ann_file="/data2/yihan/MyDataset/Cityscapes/annotations/cityscapes_instances_test_flatten_Info&License.json",
#         # data_prefix=dict(img='leftImg8bit_re_order'),
...
#         type=dataset_type,
#         data_root=data_root,
#         depth_root="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/val_depth_heat/",
#         depth_suffix=depth_suffix,
#         ann_file="/data2/yihan/MyDataset/Cityscapes/annotations/cityscapes_instances_val_flatten_Info&License.json",
#         data_prefix=dict(img='leftImg8bit_re_order'),
#         pipeline=val_pipeline,
#
#         # KITTI
#         # type="KITTI_Ins_Dataset",
#         # data_root="/data2/yihan/MyDataset/KITTI_semantics/",
#         # depth_root="/data2/yihan/MyDataset/KITTI_semantics/testing/image_2_Depth_DAV2_heat/",
#         # depth_suffix=depth_suffix,
#         # ann_file="/data2/yihan/MyDataset/KITTI_semantics/testing/test_empty_annotations.json", # 填一个空的标注文件就行
