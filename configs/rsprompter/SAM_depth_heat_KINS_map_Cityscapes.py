...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         depth_root="/data2/yihan/MyDataset/KINS/data_object_image_2/training/image_2_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
data_root = "/data2/yihan/MyDataset/KINS/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/KINS/train_map_Cityscapes.json",
        data_prefix=dict(img="data_object_image_2/training/image_2"), # 标注里的 file_name为val/xxxxxxxxxx.png，包含了train、val，因此data_prefix这里不用再加了
        pipeline=train_pipeline,
    )
)

# 验证集还是 Cityscapes的，因为我们的目的是用 KINS的数据微调在 Cityscapes上训练好的模型，以求在 cityscapes上有更好的表现
val_dataloader = dict(
    batch_size=batch_size_per_gpu,
    num_workers=num_workers,
    persistent_workers=persistent_workers,
...
resume = False
load_from = "/data2/yihan/MyProject/RSPrompter-release/work_dirs/Cityscapes_depth_heat_vith/best_coco_segm_mAP_epoch_72.pth" # 在cityscapes训练的基础上进行微调
