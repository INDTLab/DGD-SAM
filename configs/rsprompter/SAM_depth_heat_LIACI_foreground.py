...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=1, max_keep_ckpts=1, save_best=['coco/bbox_mAP', 'coco/segm_mAP'], rule='greater',
                    save_last=True),
...
# depth_root = "/data2/yihan/MyDataset/LIACi/LIACi_dataset_pretty/Depth_heat_rgb"
# depth_root = "/data3/yihan/MyDataset/LIACi_dataset_pretty/Depth_heat_rgb"
depth_root = "/root/shared-nvme/MyDataset/LIACi_dataset_pretty/Depth_heat_rgb/"
...
dataset_type = 'LIACi_foreground_InsSegDataset'
...
# data_root = "/data3/yihan/MyDataset/LIACi_dataset_pretty/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        # ann_file="/data2/yihan/MyDataset/LIACi/LIACi_dataset_pretty/train_ann_foreground_class.json",
        # ann_file="/data3/yihan/MyDataset/LIACi_dataset_pretty/train_ann_foreground_class.json",
        # ann_file="/data2/yihan/MyDataset/LIACi/LIACi_dataset_pretty/foreground/train/one_instances_per_img_train.json",
        # ann_file="/data3/yihan/MyDataset/LIACi_dataset_pretty/one_instances_per_img_train.json",
        ann_file="/root/shared-nvme/MyDataset/LIACi_dataset_pretty/one_instances_per_img_train_2.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        # ann_file="/data2/yihan/MyDataset/LIACi/LIACi_dataset_pretty/val_ann_foreground_class.json",
        # ann_file="/data3/yihan/MyDataset/LIACi_dataset_pretty/val_ann_foreground_class.json",
        # ann_file="/data2/yihan/MyDataset/LIACi/LIACi_dataset_pretty/foreground/val/one_instances_per_img_val.json",
        # ann_file="/data3/yihan/MyDataset/LIACi_dataset_pretty/one_instances_per_img_val.json",
        ann_file="/root/shared-nvme/MyDataset/LIACi_dataset_pretty/one_instances_per_img_val_2.json",
        data_prefix=dict(img='images'),
