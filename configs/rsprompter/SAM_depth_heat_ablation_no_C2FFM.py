...
depth_root_train="/data2/yihan/MyDataset/COME15K/train/depths_heat/"
depth_root_val="/data2/yihan/MyDataset/COME15K/train/depths_heat/"
depth_root_test="/data2/yihan/MyDataset/COME15K/train/depths_heat/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/COME15K/annotations/COME15K-Train.json",
        data_prefix=dict(img="train/imgs_right"),
...
val_dataloader = dict(
    ...
    #     type='COMEDataset',
    #     data_root="/data2/yihan/MyDataset/COME15K/",
    #     depth_root="/data2/yihan/MyDataset/COME15K/COME-H/depth_heat/",
    #     depth_suffix=depth_suffix,
    #     ann_file="/data2/yihan/MyDataset/COME15K/annotations/COME15K-Test-H.json",
    #     data_prefix=dict(img="COME-H/RGB"),
    #     pipeline=[
    #         dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    #         dict(type='LoadDepthFromFile',
    #              depth_root="/data2/yihan/MyDataset/COME15K/COME-H/depth_heat/",
    ...
    dataset=dict(
        type='DSISDataset',
        data_root="/data2/yihan/MyDataset/DSIS/",
        depth_root="/data2/yihan/MyDataset/DSIS/depth_heat/",
        depth_suffix=depth_suffix,
        ann_file="/data2/yihan/MyDataset/DSIS/DSIS.json",
        ...
        pipeline=[
            ...
            dict(type='LoadDepthFromFile',
                 ...
                 to_float32=True),
            dict(type='Resize', scale=crop_size, keep_ratio=True),
            dict(type='DualPad', size=crop_size, pad_val=dict(img=(0.406 * 255, 0.456 * 255, 0.485 * 255),
                                                              depth=(0.437 * 255, 0.484 * 255, 0.482 * 255),
                                                              masks=0)),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
                type='PackDetInputs',
...
test_dataloader = dict(
    ...
    #     type='COMEDataset',
    #     data_root="/data2/yihan/MyDataset/COME15K/",
    #     depth_root="/data2/yihan/MyDataset/COME15K/COME-E/depth_heat/",
    #     depth_suffix=depth_suffix,
    ...
    dataset=dict(
        ...
        depth_root="/data2/yihan/MyDataset/SIP/depth_heat/",
        depth_suffix=depth_suffix,
