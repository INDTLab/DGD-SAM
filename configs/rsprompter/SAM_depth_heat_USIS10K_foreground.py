...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/USIS10K/train_depth_heat/",
...
val_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/USIS10K/val_depth_heat/",
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/USIS10K/test_depth_heat/",
