...
# depth_root = "/data2/yihan/MyDataset/LIACi_dataset_pretty/Depth_heat_DAv1/"
# depth_root = "/data2/yihan/MyDataset/LIACi_dataset_pretty/Depth_heat_zoedepth/"
...
# DAv2
# depth_root_train="/data2/yihan/MyDataset/UIIS10K/img_depth_heat/"
# depth_root_val="/data2/yihan/MyDataset/UIIS10K/img_depth_heat/"
# depth_root_test="/data2/yihan/MyDataset/UIIS10K/img_depth_heat/"

depth_root_train="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/train_depth_heat/"
depth_root_val="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/val_depth_heat/"
depth_root_test="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/test_depth_heat/"
...
test_pipeline = [
    ...
    dict(type='Resize', scale=crop_size, keep_ratio=True),
    # Pad接收的Size是(w, h)
    dict(type='DualPad', size=(crop_size[1], crop_size[0]),
         pad_val=dict(img=(0.406 * 255, 0.456 * 255, 0.485 * 255), depth=(0.437 * 255, 0.484 * 255, 0.482 * 255),
                      masks=0)),
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    dict(
        type='PackDetInputs',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # 标注里的 file_name为val/xxxxxxxxxx.png，包含了train、val，因此data_prefix这里不用再加了
...
# 如果验证集和测试集不是同一个，就使用EvalTestHook
# custom_hooks.append(
#     dict(
#         type='EvalTestHook',
...
#             type='WandbVisBackend'),
#     ])
# work_dir = '/data2/yihan/MyProject/RSPrompter-BingXing/work_dirs/self_prompt_SEBlock'
