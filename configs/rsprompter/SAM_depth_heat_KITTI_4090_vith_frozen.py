...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/KITTI_semantics/training/image_2_depth_heat/",
         # depth_root="/data3/yihan/MyDataset/KITTI_semantics/training/image_2_depth_heat/",
         depth_root="/data2/yihan/MyDataset/KITTI_semantics/training/image_2_Depth_DAV2_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
data_root = "/data2/yihan/MyDataset/KITTI_semantics/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
# data_root = "/data3/yihan/MyDataset/KITTI_semantics/"
# data_root = "/root/shared-nvme/MyDataset/KITTI_semantics/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/KITTI_semantics/training/kitti_instances_coco_1_8.json",
        # ann_file="/data3/yihan/MyDataset/KITTI_semantics/training/kitti_instances_coco_1_8.json",
        # ann_file="/root/shared-nvme/MyDataset/KITTI_semantics/training/kitti_instances_coco_1_8.json",
