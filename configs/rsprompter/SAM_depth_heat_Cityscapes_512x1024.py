...
#          # depth_root="/data2/yihan/MyDataset/USIS16K/train2025_depth_heat/",
#          depth_root="/data2/yihan/MyDataset/Cityscapes/leftImg8bit_re_order/train_depth_heat/",
#          suffix=depth_suffix,
#          to_float32=True),
...
#         # type='RandomResize',
#         # scale=(crop_size[0]/2, crop_size[0]), # 短边缩放的范围
#         # ratio_range=(0.1, 2.0),
#         # resize_type='Resize',
#         # keep_ratio=True
#         type='RandomResize',
#         # scale=(512, 512),   # 高度基准 512
#         scale=(crop_size[0], crop_size[0]), # 高度基准 512
#         ratio_range=(1.0, 2.0),  # 把高度从 256~1024 随机, w按比例取
#         keep_ratio=True
#     ),
#     dict(
#         type='RandomCrop',
...
#     # dict(
#     #     type='RandomResize',
#     #     # scale=[(2048, 256), (2048, 1024)], # w=2048时，h在256~1024
#     #     scale=[(2048, 256), (2048, 1024)], # w=2048时，h在256~1024
#     #     keep_ratio=True
#     # ),
#     # 1. 随机缩放 (0.5x ~ 2.0x)，保持宽高比
#     dict(
#         type='RandomResize',
#         scale=(2048, 1024),   # 基准尺寸 (w, h)，就是原图大小
#         # scale=(1024, 512),   # 基准尺寸 (w, h)，就是原图大小
#         # ratio_range=(0.5, 2.0),  # 原图尺寸下随机缩放 0.5~2倍
#         ratio_range=(0.25, 2.0),  # 原图尺寸下随机缩放 0.25~2倍
#         keep_ratio=True
#     ),
#     # 2. 随机裁剪：裁成 (512, 1024)
#     dict(
#         type='RandomCrop',
#         # crop_size=(512, 1024),
#         # crop_size=crop_size, # 这里是(w,h)顺序
#         crop_size=(crop_size[1], crop_size[0]), # 这里是(w,h)顺序
#         crop_type='absolute',
#         recompute_bbox=True,
#         # allow_negative_crop=True
...
val_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         # depth_root="/data2/yihan/MyDataset/USIS16K/val2025_depth_heat/",
...
test_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         # depth_root="/data2/yihan/MyDataset/USIS16K/test2025_depth_heat/",
