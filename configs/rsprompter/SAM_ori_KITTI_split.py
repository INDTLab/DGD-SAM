...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/KITTI_semantics/split/annotations_train_split.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/KITTI_semantics/split/annotations_val_split.json", # KITTI的测试集没有标注文件，所以就不加 ann_file了
