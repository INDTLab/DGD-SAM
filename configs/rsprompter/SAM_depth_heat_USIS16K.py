...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         depth_root="/data2/yihan/MyDataset/USIS16K/train2025_depth_heat_DPT/",
         suffix=depth_suffix,
         to_float32=True),
...
val_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         depth_root="/data2/yihan/MyDataset/USIS16K/val2025_depth_heat_DPT/",
         suffix=depth_suffix,
         to_float32=True),
...
test_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         ...
         depth_root="/data2/yihan/MyDataset/USIS16K/test2025_depth_heat_DPT/",
         suffix=depth_suffix,
         to_float32=True),
    dict(type='Resize', scale=crop_size, keep_ratio=True),
    # dict(type='Pad', size=crop_size, pad_val=dict(img=(0.406 * 255, 0.456 * 255, 0.485 * 255), masks=0)),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file="/data3/yihan/MyDataset/USIS10K/multi_class_annotations/multi_class_train_annotations.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file="/data3/yihan/MyDataset/USIS10K/multi_class_annotations/multi_class_val_annotations.json",
        ann_file="/data2/yihan/MyDataset/USIS16K/annotations/instances_val2017.json",
        data_prefix=dict(img='val2025'),
