...
custom_hooks = [
    ...
    # dict(type='CustomFileLoggerHook', file_path="/root/shared-nvme/MyProject/RSPrompter-BingXing/mmdet/rsprompter/__init__.py", priority='NORMAL'),
...
# hf_sam_pretrain_name = "/root/shared-nvme/MyProject/RSPrompter-BingXing/sam-vit-large"
# hf_sam_pretrain_name = "/root/shared-nvme/MyProject/RSPrompter-BingXing/sam-vit-huge"
...
# hf_sam_pretrain_ckpt_path = "/root/shared-nvme/MyProject/RSPrompter-BingXing/sam-vit-large/pytorch_model.bin"
# hf_sam_pretrain_ckpt_path = "/root/shared-nvme/MyProject/RSPrompter-BingXing/sam-vit-huge/pytorch_model.bin"
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            # max_per_img=1000, # 最终每张图像保留的最大检测框数量
...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/DIS5K/DIS5K/DIS-TR/im_depth_heat/",
         depth_root="/data3/yihan/MyDataset/DIS5K/DIS5K/DIS-TR/im_depth_heat/",
         # depth_root="/root/shared-nvme/MyDataset/DIS5K/DIS5K/DIS-TR/im_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
    ...
    dict(
        ...
        scale=crop_size,
        ratio_range=(0.1, 2.0),
        # ratio_range=(0.5, 1.5), # 改小缩放比例，保护 small 目标
        resize_type='Resize',
        keep_ratio=True
    ),
    dict(
        ...
        # allow_negative_crop=False), # 避免裁掉所有 GT
    dict(type='FilterAnnotations', min_gt_bbox_wh=(1e-5, 1e-5), by_mask=True),
    dict(type='PackDetInputs')
]

# 暂时用训练集进行测试，因为测试集没有标注信息
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/DIS5K/DIS5K/DIS-VD/im_depth_heat/",
         depth_root="/data3/yihan/MyDataset/DIS5K/DIS5K/DIS-VD/im_depth_heat/",
         # depth_root="/root/shared-nvme/MyDataset/DIS5K/DIS5K/DIS-VD/im_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
    ...
    dict(type='DualPad', size=crop_size, pad_val=dict(img=(0.406 * 255, 0.456 * 255, 0.485 * 255), depth=(0.482*255, 0.484*255, 0.437*255), masks=0)),
    # dict(type='DualPad', size=(1024,1024), pad_val=dict(img=(0.406 * 255, 0.456 * 255, 0.485 * 255), depth=(0.437*255, 0.484*255, 0.482*255), masks=0)),
...
# code_root = "/root/shared-nvme/MyProject/RSPrompter-BingXing/"

''' 换数据集，修改这里 '''
# dataset_type = 'LIACiInsSegDataset'
# dataset_type = 'UIISInsSegDataset'
# dataset_type = 'USISInsSegDataset'
# dataset_type = 'NYUDv2_Ins_Dataset'
# dataset_type = 'KITTI_Ins_Dataset'
dataset_type = 'DIS5K_InsSegDataset'



# data_root = "/data2/yihan/MyDataset/DIS5K/DIS5K/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
data_root = "/data3/yihan/MyDataset/DIS5K/DIS5K/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
# data_root = "/root/shared-nvme/MyDataset/DIS5K/DIS5K/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file="/data2/yihan/MyDataset/DIS5K/DIS5K/DIS-TR/annotations/instances_train.json",
        ann_file="/data3/yihan/MyDataset/DIS5K/DIS5K/DIS-TR/annotations/instances_train.json",
        # ann_file="/root/shared-nvme/MyDataset/DIS5K/DIS5K/DIS-TR/annotations/instances_train.json",
        data_prefix=dict(img="DIS-TR/im"),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # depth_root="/root/shared-nvme/MyDataset/DIS5K/DIS5K/DIS-VD/im_depth_heat/",
        depth_suffix=depth_suffix,
        # ann_file="/data2/yihan/MyDataset/DIS5K/DIS5K/DIS-VD/annotations/instances_val.json",
        ann_file="/data3/yihan/MyDataset/DIS5K/DIS5K/DIS-VD/annotations/instances_val.json",
        # ann_file="/root/shared-nvme/MyDataset/DIS5K/DIS5K/DIS-VD/annotations/instances_val.json",
        data_prefix=dict(img="DIS-VD/im"),
...
#        type=dataset_type,
#        data_root=data_root,
#        # depth_root="/data2/yihan/MyDataset/DIS5K/DIS5K/DIS-TE1/im_depth_heat/",
#        depth_root="/data3/yihan/MyDataset/DIS5K/DIS5K/DIS-TE1/im_depth_heat/",
#        depth_suffix=depth_suffix,
#        # ann_file="/data2/yihan/MyDataset/DIS5K/DIS5K/DIS-TE1/annotations/instances_test.json",
#        ann_file="/data3/yihan/MyDataset/DIS5K/DIS5K/DIS-TE1/annotations/instances_test.json",
#        data_prefix=dict(img="DIS-TE1/im"),
#        pipeline=test_pipeline,
#    )
#)

# resume = True
# load_from = "/data2/yihan/MyProject/RSPrompter-release/work_dirs/UIIS_depth/epoch_14.pth"
resume = False
load_from = None
...
custom_hooks.append(dict(type='EvalTestHook',test_dataloader_cfg=test_dataloader,test_evaluator_cfg=test_evaluator))
'''
#custom_hooks.append(
#    dict(
#        type='EvalTestHook',
