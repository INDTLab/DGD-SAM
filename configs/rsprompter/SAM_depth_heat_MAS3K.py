...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         depth_root="/data2/yihan/MyDataset/MAS3K/train/Image_depth_heat/",
         # depth_root="/data3/yihan/MyDataset/MAS3K/train/Image_depth_heat/",
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         depth_root="/data2/yihan/MyDataset/MAS3K/test/Image_depth_heat/",
         # depth_root="/data3/yihan/MyDataset/MAS3K/test/Image_depth_heat/",
         # depth_root="/root/shared-nvme/MyDataset/NYUDv2/depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
dataset_type = 'MAS3K_Ins_Dataset'



# data_root = "/data2/yihan/MyDataset/NYUDv2/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
# data_root = "/data3/yihan/MyDataset/NYUDv2/"
# data_root = "/root/shared-nvme/MyDataset/NYUDv2/"
data_root = "/data2/yihan/MyDataset/MAS3K/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="/data2/yihan/MyDataset/MAS3K/annotations/instances_train.json",
        # ann_file="/data3/yihan/MyDataset/MAS3K/annotations/instances_train.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # depth_root="/root/shared-nvme/MyDataset/NYUDv2/depth_heat/",
        depth_suffix=depth_suffix,
        ann_file="/data2/yihan/MyDataset/MAS3K/annotations/instances_test.json",
        # ann_file="/data3/yihan/MyDataset/MAS3K/annotations/instances_test.json",
