...
train_pipeline = [
    ...
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/SIS10K/Train/image_depth_heat/",
         depth_root="/data3/yihan/MyDataset/SIS10K/Train/image_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
val_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/SIS10K/Val/image_depth_heat/",
         depth_root="/data3/yihan/MyDataset/SIS10K/Val/image_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
...
test_pipeline = [
    dict(type='LoadImageFromFile', backend_args=backend_args, to_float32=True),
    dict(type='LoadDepthFromFile',
         # depth_root="/data2/yihan/MyDataset/SIS10K/Test/image_depth_heat/",
         depth_root="/data3/yihan/MyDataset/SIS10K/Test/image_depth_heat/",
         suffix=depth_suffix,
         to_float32=True),
    dict(type='Resize', scale=crop_size, keep_ratio=True),
    # dict(type='Pad', size=crop_size, pad_val=dict(img=(0.406 * 255, 0.456 * 255, 0.485 * 255), masks=0)),
...
dataset_type = 'SIS10K_Ins_Dataset'

# data_root = "/data2/yihan/MyDataset/SIS10K/" # 影响下面的data_prefix=dict(img='train'), 要求data_root必须是'train'的上级路径
data_root = "/data3/yihan/MyDataset/SIS10K/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file="/data2/yihan/MyDataset/SIS10K/SIS10K_train_fixed.json",
        ann_file="/data3/yihan/MyDataset/SIS10K/SIS10K_train_fixed.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        depth_root="/data3/yihan/MyDataset/SIS10K/Val/image_depth_heat/",
        depth_suffix=depth_suffix,
        # ann_file="/data2/yihan/MyDataset/SIS10K/SIS10K_val_fixed.json",
        ann_file="/data3/yihan/MyDataset/SIS10K/SIS10K_val_fixed.json",
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        depth_root="/data3/yihan/MyDataset/SIS10K/Test/image_depth_heat/",
        depth_suffix=depth_suffix,
        # ann_file="/data2/yihan/MyDataset/SIS10K/SIS10K_test_fixed.json",
        ann_file="/data3/yihan/MyDataset/SIS10K/SIS10K_test_fixed.json",
