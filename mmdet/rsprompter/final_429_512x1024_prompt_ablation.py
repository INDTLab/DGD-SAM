...
class MyMaskHead(RSPrompterAnchorMaskHead):
    ...
    def mask_as_prompt_forward(self,
        ...
        # dense_embeddings=self.atten_fuse(mask_as_prompt_forward, dense_embeddings_bi) # Spatial+Semantic
        dense_embeddings = mask_as_prompt_forward  # 只用 Semantic Prompt
        # dense_embeddings=dense_embeddings_bi # 只用 Spatial Prompt
