...
from .my_utils import CBAM,SEBlock
...
class MyMaskHead(RSPrompterAnchorMaskHead):
    ...
    def mask_as_prompt_forward(self,
        ...
        dense_embeddings=self.SEBlock(mask_as_prompt_forward, dense_embeddings_bi)
        dense_embeddings=self.CBAM(dense_embeddings)
