...
class NWPUInsSegDataset(CocoDataset):
    ...
    def __init__(self,
                 depth_root="/data2/yihan/MyDataset/LIACi/LIACi_dataset_pretty/Depth",
                 depth_suffix='.png',
                 **kwargs
        ):
    ...
    def load_data_list(self):
        ...
        for info in data_infos:
            ...
            # 示例：将images/rgb/0001.jpg转换为depth/0001_depth.png
            filename = osp.splitext(osp.basename(img_path))[0] # image_0001
            # depth_filename = f"{filename}{self.depth_suffix}"
            depth_filename = f"{self.depth_root}/{filename}{self.depth_suffix}"
            info['depth_path'] = osp.join(self.depth_root, depth_filename)
        return data_infos
...
@DATASETS.register_module()
class LIACi_foreground_InsSegDataset(CocoDataset):
    METAINFO = {
        'classes': ['foreground'],
        'palette': [(220, 20, 60)]
    }
...
@DATASETS.register_module()
class NYUDv2_Ins_Dataset(CocoDataset):
    METAINFO = {
        'classes': ['bed', 'books', 'chair', 'furniture',
                    'painting', 'sofa', 'table', 'tv', 'window'],
        'palette': [(220, 20, 60), (255, 0, 0), (0, 0, 142), (0, 0, 70),
                    (0, 60, 100), (0, 80, 100), (0, 0, 230), (119, 11, 32),
                    (0, 255, 0)]
    }
...
@DATASETS.register_module()
class SUNRGBD_Ins_Dataset(CocoDataset):
    METAINFO = {
...
@DATASETS.register_module()
class MAS3K_Ins_Dataset(CocoDataset):
    METAINFO = {
        'classes': ['foreground'],
        'palette': [(220, 20, 60)]
    }
...
@DATASETS.register_module()
class DIS5K_InsSegDataset(CocoDataset):
    METAINFO = {
        'classes': ['foreground'],
        'palette': [(220, 20, 60)]
    }
...
@DATASETS.register_module()
class MyCityscapesDataset(CocoDataset):
    """Dataset for Cityscapes."""
...
class SOCDataset(CocoDataset):
    ...
    def __init__(self,
                 depth_root="/data2/yihan/MyDataset/isod/imgs_DAv2_depth_heat/",
                 depth_suffix='.png',
                 **kwargs
        ):
        self.depth_root = depth_root
...
class COMEDataset(CocoDataset):
    ...
    def __init__(self,
                 depth_root="/data2/yihan/MyDataset/COME15K/train/depths_heat/",
                 depth_suffix='.png',
                 **kwargs
        ):
        self.depth_root = depth_root
